...
**[👉 Managing projects from frontend](https://wedevs.com/docs/wp-project-manager/managing-projects-from-wp-project-manager-frontend/)** (Pro)
   ...
   * Manage projects without going to the backend interface.
...
**[👉 Kanban Board for WordPress](https://wedevs.com/products/plugins/wp-project-manager-pro/kanban-board/)** (Pro)
   ...
   * Create new task right from any board whenever you want with WP Project Manager
...
= v2.6.3 - December 24, 2024 =

**Added:** Warning while sending invoice to unassigned client.
**Fixed:** File download permission issue.
**Fixed:** Unassigned client invoice sent issue.
**Fixed:** Frontend file download issue.
**Fixed:** MPDF font issue.

= v2.6.2 - November 12, 2024 =

**Fixed:** Hide enter payment button when invoice is completed.
**Fixed:** buddyboss deprecated method.
**Fixed:** Task comment mention notification template mail broken.
**Fixed:** Some spelling mistake.
**Fixed:** Duplicate sub tasks when project is duplicated.
**Fixed:** Remove gibberish text from Espanol translation from Reports sub menu
**Fixed:** Stored Cross-Site Scripting (XSS) via File Upload
